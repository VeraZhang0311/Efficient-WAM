...
# -*- coding: utf-8 -*-
"""
RoboTwin2.0 Dataset Downloader
...
Usage:
    bash scripts/robotwin/download_robotwin_dataset.sh --output_dir /path/to/save
    bash scripts/robotwin/download_robotwin_dataset.sh --tasks adjust_bottle clean_mirror --output_dir /path/to/save
...
class RoboTwinDownloader:
    """
    Downloader for RoboTwin2.0 dataset ZIP files
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Download RoboTwin2.0 dataset ZIP files"
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/path/to/robotwin_raw/dataset",
    ...
    downloader = RoboTwinDownloader(use_mirror=not args.no_mirror)
